...
public class CourseControllerUnitTest {
    ...
    public void getPublicCourses_returnsOk() {
        ...
        ResponseEntity<?> resp = controller.getPublicCourses();
        assertEquals(HttpStatus.OK, resp.getStatusCode());
        // body is a List<CourseDTO>
    ...
    public void getCourseById_returnsOk_whenPublicAndAccepted() {
        ...
        // Ensure CourseDTO constructor has non-null instructor and basic fields
        User instr = com.elearning.TestUtils.buildUser(10L, "john.doe@example.com", com.elearning.model.Role.INSTRUCTOR);
        when(course.getInstructor()).thenReturn(instr);
        when(course.getId()).thenReturn(1L);
        when(course.getTitle()).thenReturn("Sample");
    ...
    public void getCourseById_returnsNotFound_whenNotPublicOrNotAccepted() {
        ...
        when(course.getStatus()).thenReturn(CourseStatus.PENDING);
